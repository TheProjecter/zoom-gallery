...
|                                                                     |
-----------------------------------------------------------------------
* @version $Id:english.php 106 2007-02-10 22:30:30Z kevinuru $
...
define("_ZOOM_SETTINGS_DDONOF","Enable Drag n Drop Uploading");
define("_ZOOM_NEW","Save new gallery");
define("_ZOOM_DEL","Delete gallery");
define("_ZOOM_ORDERSAVE", "Save Ordering");
...
define("_ZOOM_SETTINGS_DESCRINGAL","Show album description within the gallery");
...
define("_ZOOM_SETTINGS_NO_POP","Turn off all Popups");
...
define("_ZOOM_IN_DESC", "Place cursor over image and use arrow keys to adjust zoom amount.");

//Gallery actions
define("_ZOOM_SEARCH_BOX","Search this gallery");
...
define("_ZOOM_COMMENTS_INTRO","Enter your comments below:");

define("_ZOOM_NO_COMMENTS","No comments added yet.");
define("_ZOOM_SAYS","says");
...
define("_ZOOM_LIGHTBOX_NOTADDED","This item has already been added to your lightbox!");
