...
ZMG.ImageFlow = (function() {
    ...
    var conf_imageflow = 'zmg_imageflow';    // Default is 'imageflow'
    var conf_loading = 'zmg_loader';        // Default is 'loading'
    var conf_images = 'zmg_images';          // Default is 'images'
    var conf_captions = 'zmg_captions';      // Default is 'captions'
    var conf_scrollbar = 'zmg_scrollbar';    // Default is 'scrollbar'
    var conf_slider = 'zmg_slider';          // Default is 'slider'
    ...
    {   
        ...
        if (img_div.childNodes.item(array_images[caption_id]).getAttribute)
