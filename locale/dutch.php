...
|                                                                     |
-----------------------------------------------------------------------
* @version $Id:dutch.php 106 2007-02-10 22:30:30Z kevinuru $
...
define("_ZOOM_SETTINGS_DDONOF","Uploaden via Drag n Drop gebruiken");
define("_ZOOM_NEW","Bewaar nieuwe galerij");
define("_ZOOM_DEL","Verwijder galerij");
define("_ZOOM_ORDERSAVE", "Bewaar galerij volgorde");
...
define("_ZOOM_THUMB", "Zoom Thumb-code Generator");
define("_ZOOM_THUMB_DESCR", "Genereer de codes voor Zoom Thumb door middel van deze gebruikersvriendelijke tool.");
...
define("_ZOOM_SETTINGS_TAB3","Functies");
define("_ZOOM_SETTINGS_TAB4","Weergave");
define("_ZOOM_SETTINGS_TAB5","Watermerken");
define("_ZOOM_SETTINGS_TAB6","Safe Mode");
define("_ZOOM_SETTINGS_TAB7","Gebruikerstoegang");
define("_ZOOM_SETTINGS_TAB8","Reset");
define("_ZOOM_SETTINGS_ERASE","Klik op de knop hieronder om ALLE zOOm data te verwijderen en opnieuw te beginnen. Deze optie herstelt alle instellingen en verwijdert ook alle afbeeldingen!");
define("_ZOOM_SETTINGS_CONVTYPE","Afbeelding Conversietype");
define("_ZOOM_SETTINGS_GALLERY_FEATURES","Gallerij Functies");
define("_ZOOM_SETTINGS_VIEW_FEATURES","Media Functies");

define("_ZOOM_SETTINGS_GALLERY","Gallerijen");
define("_ZOOM_SETTINGS_VIEW","Media");

define("_ZOOM_SETTINGS_GENERAL_FEATURES","Algemene Functies");
...
define("_ZOOM_SETTINGS_OVERRIDE_FFMPEG","Gebruik FFmpeg, ook als deze niet niet door zOOm gedetecteerd kan worden.");
...
define("_ZOOM_SETTINGS_OVERRIDE_PDF","Gebruik pdf2text, ook als deze niet niet door zOOm gedetecteerd kan worden.");
define("_ZOOM_SETTINGS_MAXSIZE","Afbeelding max. breedte: ");
define("_ZOOM_SETTINGS_MAXSIZEKB","Medium - &oacute;&oacute;k afbeeldingen - max. grootte (in kB): ");
define("_ZOOM_SETTINGS_MAXSIZEKB_WARNING","De upload limiet van deze server, vastgesteld door uw ISP als onderdeel van de PHP configuratie, is %s.<br />Hierdoor zal het verhogen van deze waarde hier GEEN effect hebben!"); //added: 09-01-2006
...
define("_ZOOM_SETTINGS_TEMPLATE_TITLE","Sjabloon");
define("_ZOOM_SETTINGS_FEATURES_TITLE","Functies AAN/ UIT");
define("_ZOOM_SETTINGS_CSS_TITLE","Stylesheets bewerken");
define("_ZOOM_SETTINGS_DISPLAY_TITLE","Weergave data AAN/ UIT");
define("_ZOOM_SETTINGS_TEMPLATE_CHOOSE","Selecteer sjabloon om het uiterlijk van uw album te bepalen");
define("_ZOOM_SETTINGS_TEMPLATE_TABLES","Klassiek (gebruikt tabellen)");
define("_ZOOM_SETTINGS_TEMPLATE_TABLELESS","Modern (tabelloos)");
...
define("_ZOOM_SETTINGS_TOPTEN","Geef \"Top Tien\" link weer op de hoofdpagina");
define("_ZOOM_SETTINGS_LASTSUBM","Geef \"Laatst Toegevoegd\" link weer op de hoofdpagina");
...
define("_ZOOM_SETTINGS_CLOSE","Geef \"Sluiten\" link weer in popup-venster");
define("_ZOOM_SETTINGS_MAINSCREEN","Geef Hoofdscherm link weer in navigatie breadcrumb");
define("_ZOOM_SETTINGS_NAVBUTTONS","Geef Navigatie knoppen weer");
define("_ZOOM_SETTINGS_PROPERTIES","Geef Eigenschappen weer onder een medium");
define("_ZOOM_SETTINGS_MEDIAFOUND","Geef \"Media Gevonden\" tekst weer in elke galerij");
define("_ZOOM_SETTINGS_ANONYMOUS_COMMENTS","Sta anoniem toevoegen van commentaar toe");
define("_ZOOM_SETTINGS_WM_ENABLE_TITLE","Watermerken inschakelen");
define("_ZOOM_SETTINGS_WM_TITLE", "Uw watermerken");
define("_ZOOM_SETTINGS_WM_DESCR", "Uw watermerk zal bovenop de afbeeldingen geplaatst worden die u upload. "
 . "De afbeelding is dan nog wel te bekijken, maar bezoekers van uw website zullen niet meer geneigd zijn afbeeldingen te kopieren en/ of te printen."
 . "<br /><br />Suggestie: gebruik uw bedrijfslogo als watermerk. "
 . "Vergewis u ervan dat de achtergrond van de watermerk-afbeelding transparant is!");
define("_ZOOM_SETTINGS_WM_IMG", "Afbeelding");
define("_ZOOM_SETTINGS_WM_NOWATERMARKS", "Geen watermerken gevonden. U kunt hieronder een nieuw watermerk uploaden.");
define("_ZOOM_SETTINGS_WM_PLACEMENT_TITLE", "Plaatsing");
define("_ZOOM_SETTINGS_WM_PLACEMENT_DESCR", "U kunt de positie van het watermerk op een afbeelding bepalen door "
 . "&egrave;&egrave in het grijze vlak te selecteren.");
define("_ZOOM_SETTINGS_WM_FILE","Watermerk uploaden");
define("_ZOOM_SETTINGS_WM_UPLOAD_SUCCESS","Watermerk ge-upload!");
define("_ZOOM_SETTINGS_WM_UPLOAD_FAIL","Watermerk kon NIET ge-upload worden.");
define("_ZOOM_SETTINGS_WM_DEL_SUCCESS","Watermerk verwijdert!");
define("_ZOOM_SETTINGS_WM_DEL_FAIL","Watermerk kon NIET verwijderd worden");
...
define("_ZOOM_FORMCREATE_NAME","Naam");
...
define("_ZOOM_CONFIRM_WIPE","-- translate --");
...
define("_ZOOM_ALERT_MOVEFAILURE","Medium kon niet worden verplaatst!");
...
define("_ZOOM_ALERT_TOOBIG","Het bestand is te groot; %s is het toegestane maximum."); //added 08-08-2006
...
define("_ZOOM_ALERT_WATERMARKERROR","Fout tijdens toevoegen van watermerk aan de afbeelding.");
...
define ('_ZOOM_INSTALL_CREATE_DIR_WM','zOOm Media Gallery Installatie maakt de map "images/zoom/watermarks" aan...');
define ('_ZOOM_INSTALL_CREATE_DIR_SUCC','klaar!');
define ('_ZOOM_INSTALL_CREATE_DIR_FAIL','fout!');
define ('_ZOOM_INSTALL_CREATE_DBASE_SUCC','Database tabellen aangemaakt!');
define ('_ZOOM_INSTALL_UPGRADED_DBASE_SUCC','Database ge-upgrade!');
