...
|                                                                     |
-----------------------------------------------------------------------
* @version $Id:settings.php 139 2007-03-12 09:21:44Z mikedeboer $
* @package zOOmGallery
  ...
  ?>
    ...
    ?>
		...
		<tr>
		    <td width="30">&nbsp;</td>
		    <td>
			    <table border="1" cellspacing="1" cellpadding="2" class="wm_placement">
			    <tr>
			    	<td><input type="radio" name="s68" value="TL"<?php echo ($zoom->_CONFIG['wm_position'] == "TL") ? " checked" : ""; ?> /></td>
			    	<td><input type="radio" name="s68" value="TM"<?php echo ($zoom->_CONFIG['wm_position'] == "TM") ? " checked" : ""; ?> /></td>
			    	<td><input type="radio" name="s68" value="TR"<?php echo ($zoom->_CONFIG['wm_position'] == "TR") ? " checked" : ""; ?> /></td>
			    </tr>
			    <tr>
			    	<td><input type="radio" name="s68" value="CL"<?php echo ($zoom->_CONFIG['wm_position'] == "CL") ? " checked" : ""; ?> /></td>
			    	<td><input type="radio" name="s68" value="C"<?php echo ($zoom->_CONFIG['wm_position'] == "C") ? " checked" : ""; ?> /></td>
			    	<td><input type="radio" name="s68" value="CR"<?php echo ($zoom->_CONFIG['wm_position'] == "CR") ? " checked" : ""; ?> /></td>
			    </tr>
			    <tr>
			    	<td><input type="radio" name="s68" value="BL"<?php echo ($zoom->_CONFIG['wm_position'] == "BL") ? " checked" : ""; ?> /></td>
			    	<td><input type="radio" name="s68" value="BM"<?php echo ($zoom->_CONFIG['wm_position'] == "BM") ? " checked" : ""; ?> /></td>
			    	<td><input type="radio" name="s68" value="BR"<?php echo ($zoom->_CONFIG['wm_position'] == "BR") ? " checked" : ""; ?> /></td>
			    </tr>
			    </table>
				<br />
				<table border="0" cellspacing="1" cellpadding="2" width="100%" class="adminform">
