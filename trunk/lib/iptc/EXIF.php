...
function Interpret_EXIF_to_HTML( $Exif_array, $filename )
{
        ...
        $output_str .= "<h3 class=\"EXIF_Secondary_Heading\">Main Image Information</h3>\n";
        ...
        if ( array_key_exists( 1, $Exif_array ) )
        {
                ...
                $output_str .= "<h3 class=\"EXIF_Secondary_Heading\">Thumbnail Information</h3>\n";
        ...
        while ( array_key_exists( $i, $Exif_array ) )
        {
                ...
                $output_str .= "<h3  class=\"EXIF_Secondary_Heading\">Image File Directory (IFD) $i Information</h3>\n";
